...
class SupplyChainManager:
    ...
    def process_turbine_capex(self, config):
        ...
        if blade_mult == None:
            print(
                f"Warning: scenario '{blade_scenario}' not found for category 'blades'."
            )
            blade_mult = 0.0
        ...
        if nacelle_mult == None:
            print(
                f"Warning: scenario '{nacelle_scenario}' not found for category 'nacelle'."
            )
            nacelle_mult = 0.0
        ...
        if tower_scenario == "domestic, imported steel":
            ...
            if tower_mult == None:
                print(
                    f"Warning: scenario '{tower_scenario}' not found for category 'tower'."
                )
                tower_mult = 0.0
    ...
    def process_monopile_capex(self, config):
        ...
        if scenario == "domestic, imported steel":
            ...
            if mult == None:
                print(
                    f"Warning: scenario '{scenario}' not found for category 'monopile'."
                )
                mult = 0.0
    ...
    def process_transition_piece_capex(self, config):
        ...
        if scenario == "domestic, imported steel":
            ...
            if mult == None:
                print(
                    f"Warning: scenario '{scenario}' not found for category 'transition_piece'."
                )
                mult = 0.0
    ...
    def process_offshore_substation_topside_capex(self, config):
        ...
        if scenario == "domestic, imported steel":
            ...
            if mult == None:
                print(
                    f"Warning: scenario '{scenario}' not found for category 'oss_topside'."
                )
                mult = 0.0
    ...
    def process_array_cable_capex(self, project):
        ...
        if mult == None:
            print(
                f"Warning: scenario '{scenario}' not found for category 'array_cable'."
            )
            mult = 0.0
    ...
    def process_export_cable_capex(self, project):
        ...
        if mult == None:
            print(
                f"Warning: scenario '{scenario}' not found for category 'export_cable'."
            )
            mult = 0.0
